...
def read_data(self, i3, wvl, kmeansfilename = "k-means.pck", rbfilename = "rb", npzfilename = "/net/opal/Volumes/Amnesia/mpi3drun/2Druns/genohm/rain/new_inte1_02.npy.npz"):
	'''
	...
	self.i3 = data["arr_0"]
	self.wvl = data["arr_1"]
	self.pick_in = open(kmeansfilename, rbfilename) 
